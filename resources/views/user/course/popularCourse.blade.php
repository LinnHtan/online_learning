...
<div class="container">
   ...
   <div class="">
    ...
    <form action="{{ route('popular#courseList') }}" method="get">
    <div class="d-flex">
            @csrf
            <input type="text" name="searchKey" value="{{ old('searchKey') }}" class="form-control col-2 offset-9" placeholder="Search..."><button class="btn btn-dark text-white" type="submit">Search</button>
    </div>
</form>
   </div>
    ...
    <div class="col-12  mt-5">
        ...
        <table class="table table-striped ">
          ...
          @else
          <div class="">
            <h3 class="text-center p-2 bg-danger text-dark rounded">There is no popular course</h3>
          </div>
        @endif
...
<script>
    ...
    $(document).ready(function(){
         $('.enroll').click(function(){
            ...
            $.ajax({
                type: 'get',
                url: 'http://127.0.0.1:8000/user/ajax/popular/enroll',
                data: $data,
                dataType: 'json',
