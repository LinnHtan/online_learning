...
<div class="container">
   ...
   <div class="">
    ...
    <form action="{{ route('free#courseList') }}" method="get">
    <div class="d-flex">
    ...
    <div class="col-12  mt-5">
        ...
        <table class="table table-striped ">
          ...
          @else
          <div class="">
            <h3 class="text-center p-2 bg-danger text-dark rounded">There is no free course</h3>
          </div>
        @endif
...
<script>
    ...
    $(document).ready(function(){
         $('.enroll').click(function(){
            ...
            $.ajax({
                type: 'get',
                url: 'http://127.0.0.1:8000/user/ajax/free/enroll',
                data: $data,
                dataType: 'json',
