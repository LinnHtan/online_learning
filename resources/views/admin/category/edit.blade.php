 ...
 <div class="container mt-5">
    ...
    <div class="col-5 offset-3 bg-secondary p-2 rounded shadow-sm">
        <form action="{{ route('category#update', $category->id) }}" method="post">
            ...
            <div class="">
                <div class="mt-3">
                    <h4 class="text-center text-dark mt-2">Edit Course Category</h4>
                </div>
                ...
                @endif
                    <div class="">
                        ...
                        <input type="text" value="{{ old('categoryName', $category->name) }}" class="form-control my-2 @error('categoryName') is-invalid @enderror" name="categoryName" >
                        @error('categoryName')
