...
<div class="container">
    ...
    <div class="col-12  mt-5">
        ...
        <table class="table table-striped ">
              ...
              <tbody>
                 ...
                 <th class="align-middle text-center">{{ $c->category_id }}</th>
                  ...
                  <td class="align-middle">
                    <a href="{{ route('popularCourse#detailPage', $c->id) }}"><i class="fa-solid fa-circle-info text-dark me-3" title="detail"></i> </a>
                    <a href="{{ route('popularCourse#editPage', $c->id) }}"><i class="fa-solid fa-pen text-dark me-3" title="edit"></i></a>
                    <a href="{{ route('popularCourse#delete',$c->id) }}"><i class="fa-solid fa-trash-can text-dark me-3" title="delete"></i></a>
          ...
          @else
          <div class="">
            <h3 class="text-center text-dark p-2 bg-danger rounded">There is no popular course!</h3>
          </div>
        @endif
