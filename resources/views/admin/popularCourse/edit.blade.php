...
@section('source')
<div class="container">
    <form action="{{ route('popularCourse#update',$course->id) }}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row col-8 offset-2 mt-5 bg-secondary bg-opacity-50 border border-secondary  rounded p-2" border>
            ...
            <div class=" row">
                ...
                <hr>
                <div class="" >
                    <a href="{{ route('popularCourse#listPage') }}" class="text-dark text-decoration-none m-1" ><i class=" fs-5 fa-solid fa-arrow-left"></i></a>
                </div>
            </div>
