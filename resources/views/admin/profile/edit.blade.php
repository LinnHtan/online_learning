    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="col-lg-10 offset-1">
                <div class="card">
                    <div class="">
                        <h3 class="text-center mt-2">Edit Account Info</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('profileAdmin#update', Auth::user()->id ) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-4 offset-1">
                                    <div class="image" >
                                        <a href="#" >
                                            @if (Auth::user()->image == null)
                                                ...
                                                class=" img-thumbnail" src="{{ asset('image/' . (Auth::user()->gender == 'male' ? 'user.png' : 'girl.png')) }}" />
                                            @else
                                                <img style="width:250px" class=" img-thumbnail" src="{{ asset('storage/' . Auth::user()->image) }}"
                                                     />
                                            @endif
                                        </a>
                                    </div>
                                    <div class="mt-3 shadow-sm" style="width:250px">
                                    ...
                                    <div class="row  mt-3">
                                        <div class="">
                                            <button class="btn bg-dark text-white   " style="width:250px">
