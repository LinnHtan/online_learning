            ...
            <thead class="table-dark">
              ...
              <tbody>
                 ...
                 <th>{{ $p->id }}</th>
                  ...
                  <td>
                    <a href="{{ route('payment#editPage' ,$p->id) }}"><i class="fa-solid fa-pen text-dark me-3" title="edit"></i></a>
                    <a href="{{ route('payment#delete',$p->id) }}"><i class="fa-solid fa-trash-can text-dark me-3" title="delete"></i></a>
