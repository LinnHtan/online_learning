 ...
 <div class="container mt-5">
    <div class="col-5 offset-3 bg-secondary p-2 rounded shadow-sm">
        <form action="{{ route('payment#create') }}" method="post">
            ...
            <div class="">
                <div class="mt-3">
                    <h4 class="text-center text-dark mt-2">Create Payment Category</h4>
                </div>
                ...
                @endif
                    <div class="">
                        ...
                        <input type="text" class="form-control my-2 @error('paymentName') is-invalid @enderror" name="paymentName" placeholder="Enter Payment Name . . .">
                        @error('paymentName')
