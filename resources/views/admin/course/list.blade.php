              ...
              <tbody>
                 ...
                 <th class="align-middle text-center">{{ $c->category_id }}</th>
                  ...
                  <td class="align-middle">
                    <a href="{{ route('course#detailPage', $c->id) }}"><i class="fa-solid fa-circle-info text-dark me-3" title="detail"></i> </a>
                    <a href="{{ route('course#editPage', $c->id) }}"><i class="fa-solid fa-pen text-dark me-3" title="edit"></i></a>
                    <a href="{{ route('course#delete',$c->id) }}"><i class="fa-solid fa-trash-can text-dark me-3" title="delete"></i></a>
