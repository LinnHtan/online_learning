...
<div class="container">
    ...
    <div class="mt-2">
        <h3 class="text-center">Free Courses</h3>
    </div>
    ...
    <div class="col-12  mt-5">
        ...
        <table class="table table-striped ">
              ...
              <tbody>
                 ...
                 <th class="align-middle text-center">{{ $c->category_id }}</th>
                  ...
                  <td class="align-middle">
                    <a href="{{ route('freeCourse#detailPage', $c->id) }}"><i class="fa-solid fa-circle-info text-dark me-3" title="detail"></i> </a>
                    <a href="{{ route('freeCourse#editPage', $c->id) }}"><i class="fa-solid fa-pen text-dark me-3" title="edit"></i></a>
                    <a href="{{ route('freeCourse#delete',$c->id) }}"><i class="fa-solid fa-trash-can text-dark me-3" title="delete"></i></a>
          ...
          @else
          <div class="">
            <h3 class="text-center text-dark p-2 bg-danger rounded">There is no free course!</h3>
          </div>
        @endif
